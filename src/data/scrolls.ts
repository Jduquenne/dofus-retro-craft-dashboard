...
export interface ScrollResource {
  name: string;
  quantity: number;
  kind?: "equipment"; // absent = ressource classique
}
        ...
        options: [
          {
            ...
            position: [0, 3],
            resources: [
              { name: "Anneaux Agilesques", quantity: 100, kind: "equipment" },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            npc: "Loopine",
            position: [2, 17],
            resources: [{ name: "Gland", quantity: 70 }],
          },
          {
            id: "agi-normal-max",
            npc: "Max",
            position: [8, -2],
            resources: [
              { name: "Gland", quantity: 70 },
              { name: "Langue de Pissenlit Diabolique", quantity: 70 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [3, 4],
            resources: [
              { name: "Gland", quantity: 75 },
              { name: "Langue de Pissenlit Diabolique", quantity: 75 },
              { name: "Pétale de Rose Démoniaque", quantity: 70 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [3, 4],
            resources: [
              { name: "Gland", quantity: 80 },
              { name: "Langue de Pissenlit Diabolique", quantity: 80 },
              { name: "Pétale de Rose Démoniaque", quantity: 80 },
        ...
        options: [
          {
            ...
            npc: "Ali Akelle",
            position: [2, -2],
            resources: [{ name: "Pattes d'Arakne", quantity: 80 }],
          },
          {
            ...
            position: [0, 2],
            resources: [
              { name: "Amulette du Bucheron", quantity: 1, kind: "equipment" },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            npc: "Rish Claymore",
            position: [1, 3],
            resources: [{ name: "Epine de Champ Champ", quantity: 100 }],
          },
          {
            id: "for-petit-keck",
            npc: "Keck Auprune",
            position: [2, 0],
            resources: [{ name: "Peau de Larve Bleue", quantity: 100 }],
          },
          {
            id: "for-petit-ronsha",
            npc: "Ronsha",
            position: [1, -2],
            resources: [{ name: "Pic de Prespic", quantity: 80 }],
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            position: [-2, -3],
            resources: [
              { name: "Pic de Prespic", quantity: 70 },
              { name: "Pince de Crabe", quantity: 70 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            resources: [
              ...
              { name: "Pic de Prespic", quantity: 70 },
              { name: "Pince de Crabe", quantity: 75 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            resources: [
              ...
              { name: "Pic de Prespic", quantity: 75 },
              { name: "Pince de Crabe", quantity: 75 },
        ...
        options: [
          {
            ...
            position: [7, 1],
            resources: [
              { name: "Ceinture de Chance", quantity: 100, kind: "equipment" },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [0, 5],
            resources: [
              { name: "Peau de Larve Bleue", quantity: 50 },
              { name: "Peau de Larve Orange", quantity: 40 },
              { name: "Peau de Larve Verte", quantity: 40 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [5, 4],
            resources: [
              { name: "Aile de Tofu Maléfique", quantity: 30 },
              { name: "Peau de Larve Bleue", quantity: 45 },
              { name: "Peau de Larve Orange", quantity: 45 },
              { name: "Peau de Larve Verte", quantity: 45 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [2, 2],
            resources: [
              { name: "Aile de Tofu Maléfique", quantity: 40 },
              { name: "Peau de Larve Bleue", quantity: 60 },
              { name: "Peau de Larve Orange", quantity: 50 },
              { name: "Peau de Larve Verte", quantity: 50 },
              { name: "Sang du Vampire", quantity: 30 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            npc: "Zeurg",
            position: [8, 2],
            resources: [{ name: "Corne de Bouftou", quantity: 100 }],
          },
          {
            id: "sag-petit-tehachiks",
            npc: "Téha Chiks",
            position: [10, 3],
            resources: [{ name: "Champignon", quantity: 100 }],
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            position: [10, 6],
            resources: [
              { name: "Champignon", quantity: 80 },
              { name: "Graine de Tournesol", quantity: 60 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [1, 1],
            resources: [
              { name: "Champignon", quantity: 90 },
              { name: "Graine de Tournesol", quantity: 70 },
              { name: "Graine de Chanvre", quantity: 40 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            resources: [
              ...
              { name: "Champignon", quantity: 90 },
              { name: "Graine de Tournesol", quantity: 75 },
              { name: "Graine de Chanvre", quantity: 60 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            npc: "Hugo Bélo",
            position: [12, 5],
            resources: [{ name: "Défense de Sanglier", quantity: 100 }],
          },
          {
            id: "vit-petit-ariz",
            npc: "Ariz",
            position: [4, 5],
            resources: [{ name: "Gelée Bleutée", quantity: 100 }],
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            position: [3, -1],
            resources: [
              { name: "Gelée Bleutée", quantity: 80 },
              { name: "Gelée Menthe", quantity: 30 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            position: [3, 1],
            resources: [
              { name: "Gelée Bleutée", quantity: 60 },
              { name: "Gelée Menthe", quantity: 20 },
              { name: "Gelée Fraise", quantity: 25 },
            ],
          },
        ],
      },
        ...
        options: [
          {
            ...
            resources: [
              { name: "Gelée Bleutée", quantity: 60 },
              { name: "Gelée Menthe", quantity: 25 },
              { name: "Gelée Fraise", quantity: 30 },
