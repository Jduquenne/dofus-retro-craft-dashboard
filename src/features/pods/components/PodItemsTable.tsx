    ...
    <div className="panel rounded p-0 overflow-hidden flex flex-col">
      <div className="flex items-center justify-between px-4 py-2.5 bg-dofus-border/40">
        ...
        {items.length > 0 && (
          <button
            onClick={onClear}
            className="flex items-center gap-1 text-xs text-dofus-cream/50 hover:text-dofus-error transition-colors"
          >
            <X size={11} />
            Tout effacer
          </button>
      ...
      <div className="border-b border-dofus-border/30 bg-dofus-panel-lt/30 px-3 py-2.5 flex flex-wrap gap-2 items-end">
        <div className="flex flex-col gap-0.5 flex-1 min-w-0">
          <label className="text-xs uppercase tracking-wider text-dofus-text-lt">Ressource</label>
      ...
      {items.length > 0 && (
        <div className="border-t border-dofus-border/30 px-4 py-2 flex justify-between items-center bg-dofus-panel-dk/20">
          <span className="text-xs uppercase tracking-wider text-dofus-text-lt">Total pods par run</span>
