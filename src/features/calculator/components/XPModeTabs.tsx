    ...
    return (
        <div className="flex gap-1 panel-sm rounded p-1 w-fit">
            <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium transition-colors border ${mode === 'harvest'
            ...
            <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium transition-colors border ${mode === 'recipe'
                        ? 'bg-dofus-orange text-dofus-cream border-[#8A3E00]'
                        : 'text-dofus-text-md border-transparent hover:bg-dofus-panel-lt'
                    }`}
            >
